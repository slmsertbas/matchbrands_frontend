        ...
        <div>
          <div className="d-flex justify-content-between align-items-start text-start p-5 ">
            <h2 style={{ maxWidth: "400px" }}>
              What People are saying about MatchBrands
            </h2>
            <div
              style={{ minHeight: "80px" }}
              className="review-imgs d-flex gap-3 justify-content-end"
            >
