    ...
    <div className="container mt-5">
      <div className="row">
        <div className="col hero-left mt-5">
          <h1 className="border-design">
            Power Your Marketing with Influencers!
          </h1>
          <p className="mt-5 pt-3 text-start w-75">
            Empowering Collaboration Between Brands and Influencers, Connect
            with Influencers to Amplify Your Brand's Reach.
          </p>
